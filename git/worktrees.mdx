---
title: Worktrees
description: Manage multiple working directories for the same Git repository
---
...
<Warning title="Do not place worktrees inside other working directories">
...
### 1. Keep worktrees outside the main working directory
