---
title: Binary Heaps
description: Array-based complete binary trees for efficient priority queue operations
---
...
```js title="Binary Heap (PriorityQueue)"
class PriorityQueue {
  constructor(compare) {
...
<Accordion title="Percolating up">
...
<Accordion title="Percolating down">
...
Turn a random array into a Binary Heap.
