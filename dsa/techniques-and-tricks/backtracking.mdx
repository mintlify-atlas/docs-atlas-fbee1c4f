---
title: Backtracking
description: Exploring solution paths and undoing bad choices to find valid solutions
---
...
<Accordion title="Explanation: generateParenthesis(3)">
```js
...
<Accordion title="Explanation: subsets(['a', 'b', 'c'])">
```js
backtrack(0), path=[]
ADD result: []
