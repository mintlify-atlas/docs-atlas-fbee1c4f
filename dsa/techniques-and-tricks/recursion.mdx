---
title: Recursion
description: Solving problems by breaking them down into smaller subproblems using self-calling functions
---
...
<Accordion title="Explanation: reverseStr('Hello')">
```js
...
<Accordion title="Explanation: fib(6)">
```js
fib(6) = fib(5) + fib(4)
├─ fib(5) = fib(4) + fib(3)
│  ├─ fib(4) = fib(3) + fib(2)
...
<Accordion title="Explanation: countItems(['a', ['b','c'], [['d',['e','f']], 'g']])">
```js
