---
title: Graphs
description: Data structure for modeling relationships between objects using nodes and edges
---

## Overview

A graph is a data structure used to represent relationships between things. It is made up of `nodes` (vertices) that represent the objects you care about and `edges` that represent the connections between them.
