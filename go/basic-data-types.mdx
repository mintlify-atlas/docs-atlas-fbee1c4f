...
description: Understanding Go's fundamental data types including booleans, numerics, and strings with UTF-8 encoding
---
...
However, there are many characters that cannot be represented by only a single byte:
