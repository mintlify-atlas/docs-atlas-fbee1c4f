---
title: Conditions
description: Control program flow in Go using if-else statements and switch cases with pattern matching
---
...
<Info>Go auto `break` after each case implicitly, but the keyword can still be used.</Info>
